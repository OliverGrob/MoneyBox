...
abstract class ExpenseRoomDatabase: RoomDatabase() {
    ...
    private class PopulateDbAsync internal constructor(db: ExpenseRoomDatabase) : AsyncTask<Void, Void, Void>() {
        ...
        override fun doInBackground(vararg params: Void): Void? {
            ...
            expenseDao.insert(Expense(3450.0, "bkv bérlet", LocalDateTime.of(2019, 11, 9, 1, 1), 4))
            expenseDao.insert(Expense(3450.0, "bkv bérlet", LocalDateTime.of(2019, 11, 9, 1, 1), 4))
            expenseDao.insert(Expense(3450.0, "bkv bérlet", LocalDateTime.of(2019, 11, 9, 1, 1), 4))
            expenseDao.insert(Expense(3450.0, "bkv bérlet", LocalDateTime.of(2019, 11, 9, 1, 1), 4))
            expenseDao.insert(Expense(3450.0, "bkv bérlet", LocalDateTime.of(2019, 11, 9, 1, 1), 4))
            ...
            expenseDao.insert(Expense(3450.0, "bkv bérlet", LocalDateTime.of(2019, 11, 9, 1, 1), 4))
            expenseDao.insert(Expense(3450.0, "bkv bérlet", LocalDateTime.of(2019, 11, 9, 1, 1), 4))
            expenseDao.insert(Expense(1500.0, "spar fagyi", LocalDateTime.of(2019, 11, 11, 1, 1), 7))
            expenseDao.insert(Expense(3800.0, "steam: anno 1404", LocalDateTime.of(2019, 11, 13, 1, 1), 8))
            expenseDao.insert(Expense(2000.0, "steam: anno 2070", LocalDateTime.of(2019, 11, 13, 1, 1), 8))
            expenseDao.insert(Expense(4000.0, "steam: anno 2205", LocalDateTime.of(2019, 12, 13, 1, 1), 1))
            expenseDao.insert(Expense(2000.0, "kfc", LocalDateTime.of(2019, 10, 15, 1, 1), 2))
            expenseDao.insert(Expense(13500.0, "kondi bérlet", LocalDateTime.of(2018, 10, 16, 1, 1), 10))
            expenseDao.insert(Expense(13500.0, "kondi bérlet", LocalDateTime.of(2018, 10, 16, 1, 1), 10))
            expenseDao.insert(Expense(13500.0, "kondi bérlet", LocalDateTime.of(2018, 10, 16, 1, 1), 10))
            expenseDao.insert(Expense(13500.0, "kondi bérlet", LocalDateTime.of(2018, 10, 16, 1, 1), 10))
            expenseDao.insert(Expense(13500.0, "kondi bérlet", LocalDateTime.of(2018, 10, 16, 1, 1), 10))
            ...
            expenseDao.insert(Expense(13500.0, "kondi bérlet", LocalDateTime.of(2018, 10, 16, 1, 1), 10))
            expenseDao.insert(Expense(13500.0, "kondi bérlet", LocalDateTime.of(2018, 10, 16, 1, 1), 10))
            expenseDao.insert(Expense(2400.0, "spar: rágó + gyümi", LocalDateTime.of(2018, 10, 17, 1, 1), 11))
            expenseDao.insert(Expense(1000.0, "spar", LocalDateTime.of(2018, 10, 18, 1, 1), 4))
            expenseDao.insert(Expense(1650.0, "balozzo", LocalDateTime.of(2018, 10, 20, 1, 1), 6))
            ...
            expenseDao.insert(Expense(4000.0, "wow sub", LocalDateTime.of(2019, 10, 21, 1, 1), 2))
            expenseDao.insert(Expense(4000.0, "wow sub", LocalDateTime.of(2019, 10, 21, 1, 1), 2))
            expenseDao.insert(Expense(1500.0, "buli", LocalDateTime.of(2019, 1, 24, 1, 1), 3))
            expenseDao.insert(Expense(1500.0, "buli", LocalDateTime.of(2019, 1, 24, 1, 1), 3))
            expenseDao.insert(Expense(1500.0, "buli", LocalDateTime.of(2019, 1, 24, 1, 1), 3))
            expenseDao.insert(Expense(1500.0, "buli", LocalDateTime.of(2019, 1, 24, 1, 1), 3))
            expenseDao.insert(Expense(1500.0, "buli", LocalDateTime.of(2019, 1, 24, 1, 1), 3))
            ...
            expenseDao.insert(Expense(1500.0, "buli", LocalDateTime.of(2019, 1, 24, 1, 1), 3))
            expenseDao.insert(Expense(1500.0, "buli", LocalDateTime.of(2019, 1, 24, 1, 1), 3))
            expenseDao.insert(Expense(850.0, "gyros", LocalDateTime.of(2019, 4, 25, 1, 1), 6))
            expenseDao.insert(Expense(850.0, "gyros", LocalDateTime.of(2019, 4, 25, 1, 1), 6))
            expenseDao.insert(Expense(850.0, "gyros", LocalDateTime.of(2019, 4, 25, 1, 1), 6))
            expenseDao.insert(Expense(850.0, "gyros", LocalDateTime.of(2019, 4, 25, 1, 1), 6))
            expenseDao.insert(Expense(850.0, "gyros", LocalDateTime.of(2019, 4, 25, 1, 1), 6))
            ...
            expenseDao.insert(Expense(850.0, "gyros", LocalDateTime.of(2019, 4, 25, 1, 1), 6))
            expenseDao.insert(Expense(850.0, "gyros", LocalDateTime.of(2019, 4, 25, 1, 1), 6))
            expenseDao.insert(Expense(1800.0, "kfc", LocalDateTime.of(2019, 7, 26, 1, 1), 2))
            expenseDao.insert(Expense(12000.0, "berlin", LocalDateTime.of(2019, 8, 26, 1, 1), 4))
            expenseDao.insert(Expense(20140.0, "scitec vitamin + akció", LocalDateTime.of(2019, 3, 28, 1, 1), 4))
            expenseDao.insert(Expense(20140.0, "scitec vitamin + akció", LocalDateTime.of(2019, 3, 28, 1, 1), 4))
            expenseDao.insert(Expense(20140.0, "scitec vitamin + akció", LocalDateTime.of(2019, 3, 28, 1, 1), 4))
            expenseDao.insert(Expense(20140.0, "scitec vitamin + akció", LocalDateTime.of(2019, 3, 28, 1, 1), 4))
            expenseDao.insert(Expense(20140.0, "scitec vitamin + akció", LocalDateTime.of(2019, 3, 28, 1, 1), 4))
            ...
            expenseDao.insert(Expense(20140.0, "scitec vitamin + akció", LocalDateTime.of(2019, 3, 28, 1, 1), 4))
            expenseDao.insert(Expense(20140.0, "scitec vitamin + akció", LocalDateTime.of(2019, 3, 28, 1, 1), 4))
            expenseDao.insert(Expense(1240.0, "CC ivás", LocalDateTime.of(2018, 1, 30, 1, 1), 1))
            expenseDao.insert(Expense(1240.0, "CC ivás", LocalDateTime.of(2018, 1, 30, 1, 1), 1))
            expenseDao.insert(Expense(1240.0, "CC ivás", LocalDateTime.of(2018, 1, 30, 1, 1), 1))
            expenseDao.insert(Expense(1240.0, "CC ivás", LocalDateTime.of(2018, 1, 30, 1, 1), 1))
            expenseDao.insert(Expense(1240.0, "CC ivás", LocalDateTime.of(2018, 1, 30, 1, 1), 1))
            expenseDao.insert(Expense(60000.0, "zara: öltöny + cipő", LocalDateTime.of(2018, 1, 31, 1, 1), 2))
            expenseDao.insert(Expense(60000.0, "zara: öltöny + cipő", LocalDateTime.of(2018, 1, 31, 1, 1), 2))
            expenseDao.insert(Expense(60000.0, "zara: öltöny + cipő", LocalDateTime.of(2018, 1, 31, 1, 1), 2))
            expenseDao.insert(Expense(60000.0, "zara: öltöny + cipő", LocalDateTime.of(2018, 1, 31, 1, 1), 2))
            expenseDao.insert(Expense(5000.0, "sticza szülinap", LocalDateTime.of(2018, 1, 31, 1, 1), 1))
            expenseDao.insert(Expense(5000.0, "sticza szülinap", LocalDateTime.of(2018, 1, 31, 1, 1), 1))
            expenseDao.insert(Expense(5000.0, "sticza szülinap", LocalDateTime.of(2018, 1, 31, 1, 1), 1))
            expenseDao.insert(Expense(5000.0, "sticza szülinap", LocalDateTime.of(2018, 1, 31, 1, 1), 1))
            expenseDao.insert(Expense(5000.0, "sticza szülinap", LocalDateTime.of(2018, 1, 31, 1, 1), 1))
